...
<head>
  ...
  <style>
    * {
    ...
    .tool-item.active .tool-circle svg {
      stroke: #0a0a08;
    }
  ...
  <div class="page-wrap">
    ...
    <div class="perm-overlay" id="permOverlay">
      <div class="perm-cam-icon">
        <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#C9A84C" stroke-width="1.5"
    ...
    <div class="bottom-toolbar fade-2" id="bottomToolbar" style="display:none;">
      ...
      <button class="tool-item" onclick="setActiveTool(this)">
        <div class="tool-circle">
          <svg viewBox="0 0 24 24">
            <path d="M20 20H7L3 16 14 5l6 6-3.5 3.5" />
            <path d="M6.5 17.5l-2-2" /></svg>
        </div>
