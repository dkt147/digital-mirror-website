...
<body>
  ...
  <main class="main">
    ...
    <div class="page-topbar fade-1">
      ...
      <div class="page-title-center">Stencil Preview</div>
    </div>

    <!-- CONTENT HEADER -->
    <div class="fade-2">
      <div class="page-label">Your Match</div>
      <div class="page-title">Your stencil, identified.</div>
    </div>

    <!-- KIT PILL -->
    <div class="kit-pill-wrapper fade-3">
