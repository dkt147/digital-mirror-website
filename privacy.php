...
<body>
  ...
  <main class="main">
    ...
    <div class="privacy-card fade-3">
      ...
      <div class="actions">
        <button class="btn btn-primary" onclick="acceptPrivacy()" style="background-color: var(--gold); border-radius: 999px;">
          <span style="color: var(--black);">Understood. Continue.</span>
        </button>
