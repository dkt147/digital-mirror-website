...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    .empty-state p{color:var(--white-dim);line-height:1.7;margin-bottom:1.5rem;}
    ...
    .order-summary{margin-top:1.5rem;padding:1.75rem;border-radius:24px;background:rgba(255,255,255,0.03);border:1px solid var(--border);}
    .summary-row{display:flex;justify-content:space-between;align-items:center;color:var(--white-dim);margin-bottom:1rem;}
    .summary-total{font-weight:700;color:var(--white);}
  </style>
</head>
<body>
