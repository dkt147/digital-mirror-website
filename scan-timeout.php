...
<head>
  ...
  <title>Scan Timeout — Royals Arch Brow</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media (max-width: 900px) {
      ...
      .scan-card { aspect-ratio: 9 / 19; }
      .scan-content { padding: 1.25rem; }
  ...
  <main class="main">
    ...
    <div class="scan-card fade-3">
      ...
      <div class="scan-content">
        <h1 class="headline">That's taking longer than usual.</h1>
        <p class="subtext">The scan is taking a little longer than expected. Even lighting and a steady hold help the most.</p>

        <div class="gold-line"></div>

        <div class="actions">
          <a class="btn-primary" href="#">Try again</a>
          <a class="btn-link" href="feature-locked.php">Use a photo instead</a>
        </div>
      </div>
    </div>
