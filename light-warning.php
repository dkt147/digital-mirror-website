...
<head>
  ...
  <title>Light Warning — Royals Arch Brow</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media (max-width: 900px) {
      ...
      .light-card { aspect-ratio: 9 / 19; }
      .light-content { padding: 1.25rem; }
...
<body>
  ...
  <main class="main">
    ...
    <div class="page-topbar fade-1">
      ...
      <div class="page-title-center">Light Warning</div>
    </div>

    <!-- CONTENT HEADER -->
    <div class="fade-2">
      <div class="page-label">Lighting Warning</div>
      <div class="page-title">A little more light would help.</div>
    </div>
    ...
    <div class="light-card fade-3">
      ...
      <div class="light-content">
        <h1 class="headline">A little more light would help.</h1>
        <p class="subtext">For an accurate reading, we need even, direct light on your face. A lamp positioned in front of you is ideal.</p>

        <div class="gold-line"></div>

        <div class="actions">
          <a class="btn-primary" href="#">Try again</a>
          <a class="btn-link" href="camera-access.php">Use an existing photo instead</a>
        </div>
      </div>
    </div>
