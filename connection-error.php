...
<head>
  ...
  <title>Offline — Royals Arch Brow</title>
...
<body>
  ...
  <main class="main">
    ...
    <div class="page-topbar fade-1">
      ...
      <div class="page-title-center">Offline</div>
    </div>

    <!-- CONTENT HEADER -->
    <div class="fade-2">
      <div class="page-label">Offline Status</div>
      <div class="page-title">You're offline.</div>
    </div>

    <!-- OFFLINE CARD -->
    <div class="offline-card fade-3">
      <div class="icon-wrapper">
        <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M6 12 Q16 2 26 12" />
          <path d="M10 16 Q16 10 22 16" />
      ...
      <div class="status-list">
        ...
        <div class="status-item">
          ...
          <span class="status">Needs Internet</span>
        </div>
        <div class="status-item">
      ...
      <div class="actions">
        ...
        <a class="btn-secondary" href="between-connections.php">Continue offline</a>
      </div>
    </div>
