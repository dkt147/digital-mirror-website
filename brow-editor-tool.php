...
<body>
  ...
  <main class="main">
    ...
    <div class="tool-tabs fade-4">
      <button class="tool-tab">Shape</button>
      <button class="tool-tab">Colour</button>
      <button class="tool-tab">Thickness</button>
      <button class="tool-tab active">Position</button>
    </div>

    <!-- FEEDBACK CARD -->
    <div class="feedback-card fade-5">
      <p class="feedback-text">Continuing as drawn. Brow spacing unlocked for this session.</p>
    </div>

    <p class="help-text">Select a tool to continue editing.</p>
