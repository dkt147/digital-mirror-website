...
<body>
  ...
  <main class="main">
    ...
    <div class="actions fade-4">
      <button class="btn-primary" id="confirm-tone-btn" onclick="confirmTone()" style="background-color: var(--gold); border-radius: 999px;">
        <span id="btn-text" style="color: var(--black);">Confirm this tone →</span>
