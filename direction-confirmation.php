...
<body>
  ...
  <main class="main">
    ...
    <div class="actions fade-5">
      <a href="onboarding-complete.php" class="btn-primary" style="background-color: var(--gold); border-radius: 999px;">
        <span style="color: var(--black);">This is my direction →</span>
      </a>
