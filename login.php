    ...
    <div class="login-card">
        ...
        <form class="login-form" id="login-form" onsubmit="handleLogin(event)" novalidate>
            ...
            <div class="form-group">
                <div class="input-wrapper">
                    ...
                    <input class="form-input valid" id="login-email" type="email" placeholder=" " autocomplete="email"
                        oninput="validateField('login-email', 'email')"
                        onblur="validateField('login-email', 'email')" />
                </div>
            ...
            <div class="form-group">
                <div class="input-wrapper">
                    ...
                    <input class="form-input" id="login-pass" type="password" placeholder=" "
                        autocomplete="current-password" style="padding-right:3.2rem;"
                        oninput="validateField('login-pass', 'password')"
            ...
            <button type="submit" class="btn btn-primary" id="submit-btn" style="background-color: var(--gold); border-radius: 999px;">
                <span id="btn-text" style="color: var(--black);">Sign In</span>
